! function(e, t) {
    ...
    return function(e) {
        ...
        1: function(e, t, i) {
            ...
            var n = i(0);
            const o = window.THREE || {},
                r = "object" == typeof window;
            r && !window.VANTA && (window.VANTA = {
                version: "0.5.0"
            });
            const s = r && window.VANTA || {};
            ...
            s.VantaBase = class {
                constructor(e = {}) {
                    if (!r) return !1;
                    var t, i, l, h;
                    if (s.current = this, this.windowMouseMoveWrapper = this.windowMouseMoveWrapper.bind(this), this.resize = this.resize.bind(this), this.animationLoop = this.animationLoop.bind(this), this.restart = this.restart.bind(this), this.options = Object(n.c)({}, this.defaultOptions), e instanceof HTMLElement || "string" == typeof e ? Object(n.c)(this.options, {
                            el: e
                        }) : Object(n.c)(this.options, e), this.el = this.options.el, null == this.el) a('Instance needs "el" param!');
                    ...
                    try {
                        ...
                        return i = e, a("Init error"), a(i), this.el.removeChild(this.renderer.domElement), void(this.options.backgroundColor && (console.log("[VANTA] Falling back to backgroundColor"), this.el.style.background = Object(n.a)(this.options.backgroundColor)))
                    }
                    window.addEventListener("resize", this.resize), this.resize(), this.animationLoop(), window.addEventListener("scroll", this.windowMouseMoveWrapper), window.addEventListener("mousemove", this.windowMouseMoveWrapper)
                }
                ...
                windowMouseMoveWrapper(e) {
                    const t = this.renderer.domElement.getBoundingClientRect(),
                        i = e.clientX - t.left,
                        n = e.clientY - t.top;
                    i >= 0 && n >= 0 && i <= t.width && n <= t.height && !this.options.mouseEase && (this.mouseX = i, this.mouseY = n, this.triggerMouseMove(i, n))
                }
        ...
        16: function(e, t, i) {
            ...
            function r(e, t, i) {
                ...
                n.add(a), this.addVariable = function(e, t, i) {
                    ...
                    return i = i || e, n = n || t, o = o || THREE.ClampToEdgeWrapping, r = r || THREE.ClampToEdgeWrapping, s = s || THREE.NearestFilter, a = a || THREE.NearestFilter, new THREE.WebGLRenderTarget(i, n, {
                        wrapS: o,
                        wrapT: r,
                        minFilter: s,
                        magFilter: a,
            ...
            var d = function(e = {}) {
                ...
                s.Geometry.call(this), i(5, 0, 0), i(-5, -2, 1), i(-5, 0, 0), i(-5, -2, -1), i(0, 2, -6), i(0, 2, 6), i(2, 0, 0), i(-3, 0, 0), n(0, 2, 1), n(4, 7, 6), n(5, 6, 7), this.computeFaceNormals()
            };
            d.prototype = Object.create(s.Geometry.prototype);
            var p = function() {
                var e, t, i = new s.Vector3,
                    n = 500,
                    o = 500,
                    r = 200,
                    a = !1;
                this.position = new s.Vector3, this.velocity = new s.Vector3, e = new s.Vector3, this.setGoal = function(e) {
                    t = e
                    ...
                    a && (i.set(-n, this.position.y, this.position.z), (i = this.avoid(i)).multiplyScalar(5), e.add(i), i.set(n, this.position.y, this.position.z), (i = this.avoid(i)).multiplyScalar(5), e.add(i), i.set(this.position.x, -o, this.position.z), (i = this.avoid(i)).multiplyScalar(5), e.add(i), i.set(this.position.x, o, this.position.z), (i = this.avoid(i)).multiplyScalar(5), e.add(i), i.set(this.position.x, this.position.y, -r), (i = this.avoid(i)).multiplyScalar(5), e.add(i), i.set(this.position.x, this.position.y, r), (i = this.avoid(i)).multiplyScalar(5), e.add(i)), Math.random() > .5 && this.flock(t), this.move()
                }, this.flock = function(i) {
                    t && e.add(this.reach(t, .005)), e.add(this.alignment(i)), e.add(this.cohesion(i)), e.add(this.separation(i))
                }, this.move = function() {
                    this.velocity.add(e);
                    var t = this.velocity.length();
                    t > 4 && this.velocity.divideScalar(t / 4), this.position.add(this.velocity), e.set(0, 0, 0)
                }, this.checkBounds = function() {
                    this.position.x > n && (this.position.x = -n), this.position.x < -n && (this.position.x = n), this.position.y > o && (this.position.y = -o), this.position.y < -o && (this.position.y = o), this.position.z > r && (this.position.z = -r), this.position.z < -r && (this.position.z = r)
                    ...
                    var i = this.position.distanceTo(t);
                    if (i < 150) {
                        var n = new s.Vector3;
                        n.subVectors(this.position, t), n.multiplyScalar(.5 / i), e.add(n)
                    }
                }, this.reach = function(e, t) {
                    var i = new s.Vector3;
                    return i.subVectors(e, this.position), i.multiplyScalar(t), i
                }, this.alignment = function(e) {
                    for (var t, i, n = new s.Vector3, o = 0, r = 0, a = e.length; r < a; r++) Math.random() > .6 || (i = (t = e[r]).position.distanceTo(this.position)) > 0 && i <= 100 && (n.add(t.velocity), o++);
                    if (o > 0) {
                        n.divideScalar(o);
                        var l = n.length();
                        l > .1 && n.divideScalar(l / .1)
                    }
                    return n
                }, this.cohesion = function(e) {
                    for (var t, i, n = new s.Vector3, o = new s.Vector3, r = 0, a = 0, l = e.length; a < l; a++) Math.random() > .6 || (i = (t = e[a]).position.distanceTo(this.position)) > 0 && i <= 100 && (n.add(t.position), r++);
                    r > 0 && n.divideScalar(r), o.subVectors(n, this.position);
                    var h = o.length();
                    return h > .1 && o.divideScalar(h / .1), o
                }, this.separation = function(e) {
                    for (var t, i, n = new s.Vector3, o = new s.Vector3, r = 0, a = e.length; r < a; r++) Math.random() > .6 || (i = (t = e[r]).position.distanceTo(this.position)) > 0 && i <= 100 && (o.subVectors(this.position, t.position), o.normalize(), o.divideScalar(i), n.add(o));
                    return n
                }
            };
            ...
            class x extends n.b {
                ...
                onInit() {
                    ...
                    if (a) try {
                        ...
                        for (var r = 0; r < a; r++) {
                            (n = t[r] = new p).position.x = 400 * Math.random() - 200, n.position.y = 400 * Math.random() - 200, n.position.z = 400 * Math.random() - 200, n.velocity.x = 2 * Math.random() - 1, n.velocity.y = 2 * Math.random() - 1, n.velocity.z = 2 * Math.random() - 1, n.setAvoidWalls(!0), n.setWorldSize(500, 500, 400);
                            ...
                            for (var l = 0; l < u.faces.length; l++)
                                if (c)
                                    ...
                                    }(o = e[r] = new s.Mesh(u, new s.MeshBasicMaterial({
                                        color: 16777215,
                                        side: s.DoubleSide,
                ...
                onMouseMove(e, t) {
                    if (this.mouseX = e - .5, this.mouseY = t - .5, !a) {
                        const e = this.boids;
                        let t;
                        for (var i = new s.Vector3(this.mouseX * this.width, -this.mouseY * this.height, 0), n = 0, o = e.length; n < o; n++) t = e[n], i.z = t.position.z, t.repulse(i)
                    }
                }
                onDestroy() {}
                onResize() {}
            ...
            x.initClass();
            t.default = n.a.register("BIRDS", x)
        }
    })
});