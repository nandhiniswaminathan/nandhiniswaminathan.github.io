...
! function(n) {
    n("html").removeClass("no-js"), n("header a").click(function(e) {
        if (!n(this).hasClass("no-scroll")) {
            ...
            n("html, body").animate({
                scrollTop: i + "px"
            }, Math.abs(window.pageYOffset - n(t).offset().top) / 5), n("header").hasClass("active") && n("header, body").removeClass("active")
        }
    }), 
    ...
    n("#view-more-experiences").click(function(e) {
        e.preventDefault(), n(this).fadeOut(300, function() {
            n("#more-experiences").fadeIn(300)
        })
    }),
